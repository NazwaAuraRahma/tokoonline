...
{
    $characters = '0123456789kejjhakhdkad';
    ...
    <div class="container mt-5">
        ...
        <div class="my-5 col-12 col-md-6">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <button type="submit" class="btn btn-light text-light" style="background-color: #FF69B4" name="simpan">Simpan</button>
                </div>
            </form>
            ...
            ?>
                    ...
                    ?>
                            <div class="alert alert-warning mt-3" role="alert">
                                File tidak boleh lebih dari 1000 MB!
                            </div>
                            <?php
                        } else {
                        ...
                        ?>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="produk-detail.php?p=<?php echo $data['id']; ?>" class="btn btn-info text-light" style="background-color: #FF69B4"><i class="fas fa-search"></i></a>
                                    </td>
                                </tr>
