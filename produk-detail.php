...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 mb-5">
                    <img src="gambar/<?php echo $produk['foto'] ?>" class="w-100" alt="">
                </div>
    ...
    <!-- Produk Terkait -->
    <div class="cotainer-fluid py-5 warna2">
        <div class="container">
                ...
                ?>
                    <div class="col-md-6 col-lg-3 mb-3">
                        <a href="produk-detail.php?nama=<?php echo $data['nama']; ?>">
                            <img src="gambar/<?php echo $data['foto']; ?>" class="img-fluid img-thumbnail produk-terkait-image" alt="">
                        </a>
                    </div>
                <?php } ?>
            </div>
